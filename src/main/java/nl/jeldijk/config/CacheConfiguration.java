...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, nl.jeldijk.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, nl.jeldijk.repository.UserRepository.USERS_BY_EMAIL_CACHE);
